...
sjtubbs = {
        ...
        'dom_row_pattern' :"""
            <tr>             <td >[<a href="$boardlink">$board</a>]</td>             <td><a href="$titlelink">$title</a></td>             <td>$author</td>             </tr>
        """,
        'bbsname':'sjtu',
        'schoolname':u'上海交通大学',
        'chinesename':u'饮水思源',
        ...
        #'re_block':re.compile(r'<td valign="middle"><font color="#FFFFFF"><img src="iconT.gif"> <b>.*?</b></font></td>\n                                </tr>\n                \t\t</table>\n                \t</td>\n                  </tr>.*?</table>', re.DOTALL),
        're_block_t':r'<td valign="middle"><font color="#FFFFFF"><img src="iconT.gif"> <b>.*?</b></font></td>\n                                </tr>\n                \t\t</table>\n                \t</td>\n                  </tr>.*?</table>',
    };
...
fudanbbs = {
        ...
        """,
        #'re_block':re.compile(r"<bbstop10>.*?</bbstop10>", re.DOTALL),
        're_block_t':r"<bbstop10>.*?</bbstop10>",
        'rank':3,
        'parsetype':PARSE_USE_REGEX,
        'additional':'special',
    };
...
csubbs = {
        ...
        'chinesename':u'云麓园',
        'dom_row_pattern' : """
           <li><span><a href='$authorlink' *>$author</a></span><a href='$titlelink' title='$title' *>*</a></li>
        """,
        #'re_block':re.compile(r'<div class="homegridslist" id="homegrids_c_3">.*?</div>', re.DOTALL),
        're_block_t':'<div class="homegridslist" id="homegrids_c_3">.*?</div>', 
        'rank':19,
        'parsetype':PARSE_USE_REGEX,
    }; 
...
seubbs = {
        ...
        """,
        're_block_t':r'<h3>\xe4\xbb\x8a\xe6\x97\xa5\xe5\x8d\x81\xe5\xa4\xa7\xe7\x83\xad\xe7\x82\xb9\xe8\xaf\x9d\xe9\xa2\x98</h3>\n\t\t\t<ul>.*?</ul>', 
        're_board1':re.compile(r'board.*?=(?P<board>.*?)&', re.DOTALL),
        're_board1_t':r'board.*?=(?P<board>.*?)&', 
        'rank':20,
        'parsetype':PARSE_USE_REGEX,
...
hitbbs = {
        ...
        #'re_block':re.compile(r'<rss version="2.0">.*?</rss>', re.DOTALL),
        #'re_board':re.compile(r'\[(?P<board>.*?)\] (?P<title>.*)', re.DOTALL),
        're_block_t':r'<div id="portal_block_302_content" class="content">.*?</div>', 
        #'re_board_t':r'\[(?P<board>.*?)\] (?P<title>.*)', 
        'encoding':'utf8',
        'rank':14,
        'parsetype':PARSE_USE_REGEX,
...
buaabbs = {
        ...
        [<a href="$boardlink">$board</a>]
        <a href="$titlelink">$title </a></td><td class="HotAuthor"><a href="$authorlink">$author</a>&nbsp;&nbsp;</td></tr>
        """,
        #'re_block':re.compile(r'<table border="0" cellpadding="0" cellspacing="0" class="HotTable" align="center">.*?</table>', re.DOTALL),
        're_block_t':r'<table border="0" cellpadding="0" cellspacing="0" class="HotTable" align="center">.*?</table>', 
        'rank':22,
        'parsetype':PARSE_USE_REGEX,
    }  ;
...
bbs_setting_list = [ recommend, newsmth,sjtubbs , jlubbs, xmubbs , sdubbs, seubbs,  lzubbs, caubbs ,
